...
public class UserUnitTest {
    ...
    public void testGetAllCategory(){
        ...
        List<UserDTOAfterAuthorization> vapeDTOS= userService.showObjects();
    ...
    public void testUpdateCategory(){
        ...
        Assertions.assertEquals(userService.updateObject(userDto).getId(), user.getId());
    ...
    public void testDeleteCategory(){
        ...
        Assertions.assertTrue(userService.deleteObject(1));
